...
#     score = train.predict(path, bcdssm, sentence_field, label_field, id_field, args.cuda)
# elif args.test:
#     try:
#         train.eval(train_iter, bcdssm, args)
#     except Exception as e:
#         print("\nSorry. The test dataset doesn't  exist.\n")
# else:
#     print()
#     try:
#         train.train(train_iter, val_iter, bcdssm, args, sentence_field, label_field)
